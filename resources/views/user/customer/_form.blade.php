        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group required {{ $errors->has('user_avatar_file') ? 'has-error' : '' }}">
                    {!! Form::label('user_avatar', trans('customer.profile_picture'), ['class' => 'control-label ']) !!}
                    <div class="controls row">
                        <div class="col-sm-6 col-lg-4">
                            <div class="row">
                                @if(isset($customer->user->user_avatar))
                                    <image-upload name="user_avatar_file" old-image="{{ $customer->user->avatar}}"></image-upload>
                                @else
