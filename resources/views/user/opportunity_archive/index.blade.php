                                    ...
                                    <li>
                                        <div class="checkbox">
                                            <label for="column5" class="toggle-vis">
                                                <input type="checkbox" class="icheckblue" data-column="5" id="column5"> {{ trans('opportunity.company_name') }}
                                            </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="checkbox">
                                            <label for="column6" class="toggle-vis">
                                                <input type="checkbox" class="icheckblue" data-column="6" id="column6"> {{ trans('opportunity.customer') }}
                                            </label>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="checkbox">
                                            <label for="column8" class="toggle-vis">
                                                <input type="checkbox" class="icheckblue" data-column="8" id="column8"> {{ trans('opportunity.next_action') }}
                                            </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="checkbox">
                                            <label for="column9" class="toggle-vis">
                                                <input type="checkbox" class="icheckblue" data-column="9" id="column9"> {{ trans('opportunity.expected_closing') }}
                                            </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="checkbox">
                                            <label for="column10" class="toggle-vis">
                                                <input type="checkbox" class="icheckblue" data-column="10" id="column10"> {{ trans('opportunity.lost_reason') }}
                                            </label>
                                        </div>
                                    </li>
                                </ul>
