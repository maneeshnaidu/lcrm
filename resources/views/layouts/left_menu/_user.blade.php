...
<div id="menu" role="navigation">
    <ul class="navigation">
        ...
        @if(isset($user) && ($user->hasAccess(['sales_orders.read']) || isset($orgRole) && $orgRole=='admin'))
            <li {!! (Request::is('sales_order/*') || Request::is('sales_order') ||
              Request::is('salesorder_delete_list/*') || Request::is('salesorder_delete_list') ||
              Request::is('salesorder_invoice_list/*') || Request::is('salesorder_invoice_list')? 'class="active"' : '') !!}>
        ...
        <li {!! (Request::is('todo/*') || Request::is('todo') ? 'class="active"' : '') !!}>
            <a href="{{url('/todo')}}">
                <span class="nav-icon">
                    <i class="material-icons text-success">layers</i>
                </span>
