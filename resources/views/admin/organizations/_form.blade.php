    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group required {{ $errors->has('organization_avatar_file') ? 'has-error' : '' }}">
                    {!! Form::label('organization_avatar_file', trans('organizations.organization_avatar'), ['class' => 'control-label']) !!}
                    <div class="row">
                        @if(isset($organization->logo))
                            <image-upload name="organization_avatar_file"
                                          old-image="{{ url('uploads/organizations/thumb_'.$organization->logo) }}"></image-upload>
                        @else
