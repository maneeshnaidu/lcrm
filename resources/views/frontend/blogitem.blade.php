                            ...
                            <div class="card-body comment_section">
                                ...
                                @endif
                                    <p class="additional-post-wrap">
                                        ...
                                        <span class="additional-post mr-3">
                                            <i class="fa fa-clock-o text-success"></i><a href="#" class="text-primary"> {{$blog->created_at->diffForHumans()}}</a>
                                        </span>
                                        <span class="additional-post">
                                            <i class="fa fa-comment text-warning"></i><a href="#" class="text-primary"> {{$blog->comments->count()}} comments</a>
                                        </span>
                                    </p>
                                <p class="text_light">
                                    {!! $blog->content !!}
                                ...
                                <p>
                                    ...
                                    $share->page(url('blogitem/'.$blog->slug), $blog->title,['class' => 'btn_facebook social_share'])->facebook();
                                    $share->page(url('blogitem/'.$blog->slug), $blog->title,['class' => 'btn_twitter social_share'])->twitter();
                                    $share->page(url('blogitem/'.$blog->slug), $blog->title,['class' => 'btn_googleplus social_share'])->googlePlus();
                                    $share->page(url('blogitem/'.$blog->slug), $blog->title,['class' => 'btn_linkedin social_share'])->linkedin();
                                    echo $share;
                                    ?>
                            </div>
                        </div>
