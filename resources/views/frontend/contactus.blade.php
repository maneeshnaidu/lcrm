...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h2 class="mt-3 text-center heading">{{ trans('frontend.get_in_touch') }}</h2>
        ...
        <div class="card">
            <div class="card-body contact_form m-b-30">
                <h2 class="mb-5 text-center heading mt-3">FeedBack</h2>
