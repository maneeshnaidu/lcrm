        ...
        switch ($this->method()) {
            ...
            if (preg_match("/\/(\d+)$/", $this->url(), $mt)) {
                ...
                return [
                    ...
                    'user_avatar_file' => 'mimes:jpeg,bmp,jpg,png|max:'.$max_upload_file_size
                ];
...
//            'user_avatar_file.mimes' => 'should not be other image',
//            'user_avatar_file.max' => 'image size should be less than 1MB',
