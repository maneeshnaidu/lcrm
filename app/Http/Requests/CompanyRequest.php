        ...
        switch ($this->method()) {
            ...
            case 'POST':
                return [
                    ...
                    'email' => 'required|email|unique:companies,email',                    'country_id' => 'required',                    'state_id' => 'required',
                    'city_id' => 'required',
                    'phone' => 'required|regex:/^\d{5,15}?$/',
                    'website' => 'url',
                    'mobile' => 'regex:/^\d{5,15}?$/',
                    'fax' => 'regex:/^\d{5,15}?$/',
                    'company_avatar_file' => 'mimes:jpeg,bmp,jpg,png|max:'.$max_upload_file_size,
                ];
...
//                    'address' => '',
    ...
    public function messages()
    {
        return [
            ...
            'company_avatar_file' =>"image type can be jpg, png"
        ];
    }
}
