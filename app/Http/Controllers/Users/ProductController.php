...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        if ($request->hasFile('product_image_file')) {
            ...
            $file_name = $this->imageRepository->uploadImage($file, 'products');
            $this->imageRepository->generateThumbnail($file_name, 'products');
    ...
    public function edit($product)
    {
        ...
        $product = $this->productRepository->getAll()->find($product);
        if (!isset($product)) {
