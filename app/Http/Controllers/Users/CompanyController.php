...
class CompanyController extends Controller
{
    ...
    public function store(CompanyRequest $request)
    {
        ...
        if ($request->hasFile('company_avatar_file')) {
            ...
            $file_name = $this->imageRepository->uploadImage($file, 'company');
            $this->imageRepository->generateThumbnail($file_name, 'company');

            $request->merge([
                'company_avatar' => $file_name,
            ]);
        }
    ...
    public function edit($company)
    {
        ...
        $company = $this->companyRepository->getAll()->find($company);
        if (!isset($company)) {
